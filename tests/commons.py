...
VARIANTS = {
    ...
    '13_16del4': {'type': 'deletion',
                  'location': get_location(13, 16),
                  'deleted': [{'length': 4,
                               'source': 'description'}],
                  'source': 'reference'},
    '12_16del4': {'type': 'deletion',
                  'location': get_location(12, 16),
                  'deleted': [{'length': 4,
                               'source': 'description'}],
                  'source': 'reference'},
    ...
    '4_4insT': {'type': 'insertion',
                ...
                'inserted': [{'sequence': 'T',
                              'source': 'description'}]},
    '15_15insT': {'type': 'insertion',
                  'source': 'reference',
                  'location': get_location(15, 15),
                  'inserted': [{'sequence': 'T',
                                'source': 'description'}]},
    ...
    '4_4ins[6_8;9_20;T]': {'type': 'insertion',
                           ...
                           'inserted': [{'source': 'reference',
                                        ...
                                        {'sequence': 'T',
                                         'source': 'description'}]},
    '11_13inv': {'type': 'inversion',
                 'source': 'reference',
                 'location': get_location(11, 13)},
    '10_13inv': {'type': 'inversion',
                 'source': 'reference',
    ...
    '4delins7_8': {'type': 'deletion_insertion',
                   ...
                   'inserted': [{'source': 'reference',
                                 'location': get_location(7, 8)}]},
    '3_4delins': {'type': 'deletion_insertion',
                  'source': 'reference',
                  'location': get_location(3, 4)},
    '3_5delins': {'type': 'deletion_insertion',
                  'source': 'reference',
                  'location': get_location(3, 5)},
    '3_4delins3_4': {'type': 'deletion_insertion',
                     'source': 'reference',
                     'location': get_location(3, 4),
                     'inserted': [{'source': 'reference',
                                   'location': get_location(3, 4)}]},
    '3_4delins6_8': {'type': 'deletion_insertion',
                     ...
                     'inserted': [{'source': 'reference',
                                   'location': get_location(6, 8)}]},
    '3_5delins6_8': {'type': 'deletion_insertion',
                     'source': 'reference',
                     'location': get_location(3, 5),
                     'inserted': [{'source': 'reference',
                                   'location': get_location(6, 8)}]},
    '4_5delins7_8': {'type': 'deletion_insertion',
                     ...
                     'inserted': [{'source': 'reference',
                                   'location': get_location(7, 8)}]},
    '4_4delins3_4': {'type': 'deletion_insertion',
                     'source': 'reference',
                     'location': get_location(4, 4),
                     'inserted': [{'source': 'reference',
                                   'location': get_location(3, 4)}]},
    '4_4delins[6_8;9_20]': {'type': 'deletion_insertion',
                            'source': 'reference',
                            'location': get_location(4, 4),
                            'inserted': [{'source': 'reference',
                                          'location': get_location(6, 8)},
    ...
    '4_4delinsAA': {'type': 'deletion_insertion',
                    ...
                    'inserted': [{'source': 'description',
                                  'sequence': 'AA'}]},
    '3_4delAinsT': {'type': 'deletion_insertion',
                    'source': 'reference',
                    'location': get_location(3, 4),
    ...
    '10_13delins10_13inv': {'type': 'deletion_insertion',
                            ...
                            'inserted': [{'source': 'reference',
                                          'location': get_location(10, 13),
                                          'inverted': True}]},
    '15_15delinsT': {'type': 'deletion_insertion',
                     'source': 'reference',
                     'location': get_location(15, 15),
                     'inserted': [{'source': 'description',
                                   'sequence': 'T'}]},
