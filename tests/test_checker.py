...
TESTS_ERROR = [
    ...
    ("NG_007485.1(NR_003529.3):n.-40000del", "EOUTOFBOUNDARY"),
    ("NG_007485.1(NR_003529.3):n.10delinsNG_007485.1:g.-1", "EOUTOFBOUNDARY"),
    ("NG_007485.1(NR_003529.3):n.10delinsNG_007485.1:g.0", "EOUTOFBOUNDARY"),
    ("NG_007485.1(NR_003529.3):n.10delinsNG_007485.1:g.100000000", "EOUTOFBOUNDARY"),
    ("NG_007485.1(NM_000077.4):c.135_130insT", "ERANGEREVERSED"),
    # Negative strand.
    ("NG_012337.1(NM_012459.2):c.135_130insT", "ERANGEREVERSED"),
    (
        "NG_012337.1(NM_012459.2):c.130_131ins[NG_007485.1:g.100000000;AAA]",
        "EOUTOFBOUNDARY",
    ),
