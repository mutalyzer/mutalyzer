...
TESTS = [
    ...
    ('NG_012337.1:g.4delins7_31',
     'NG_012337.1:g.4delins7_31'),
    # Specific locus
    ('NG_007485.1(NM_000077.4):c.274G>T',
     'NG_007485.1:g.28407G>T'),
    # Roll
...
@pytest.mark.parametrize(
    'hgvs_description, normalized_description', TESTS)
...
@pytest.mark.parametrize(
    ...
    [
     ('NG_012337.1:c.10del',
      'No selector. Choose from: C11orf57_v001 <-> NM_018195.3,'
      'C11orf57_v002 <-> NM_001082969.1, C11orf57_v003 <-> NM_001082970.1,'
      'TIMM8B_v004 <-> NM_012459.2, SDHD_v005 <-> NM_003002.2.'),
